...
INSERT INTO "Semester" (s_term, s_year)
VALUES
    ('Fall'::termenum, 2020),
    ('First Summer'::termenum, 2020),
    ('Six Week Summer', 2020);
...
INSERT INTO "Student" (st_email, dept_id) VALUES ('pepo@upr.edu', 1);
INSERT INTO "Student" (st_email, dept_id) VALUES ('keno@upr.edu', 2);
INSERT INTO "Student" (st_email, dept_id) VALUES ('tata@upr.edu', 3);
...
INSERT INTO "TimeSlot" (ts_start_time, ts_end_time, so_id, ts_day) VALUES
    ('3:30'::time, '4:45'::time, 1, 'Monday'::dayenum),
    ('3:30'::time, '4:45'::time, 1, 'Wednesday'::dayenum),
    ('3:30'::time, '4:45'::time, 1, 'Friday'::dayenum);
