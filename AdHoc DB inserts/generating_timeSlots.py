...
class TimeSlotGenerator:
    ...
    def timeSlotInsert(self):
        for i in self.trimAndSelectDays(self.days):
            print('insert into "TimeSlot" (ts_start_time, ts_end_time, so_id, d_id) VALUES (%s,%s,%d,%d);'  % (self.getStartTime(), self.getEndTime(), self.so_id, i))

inserts = [ (1846, '12:30- 1:20p', 'W      ', '60'),
